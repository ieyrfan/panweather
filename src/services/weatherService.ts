...
export async function fetchAirQualityData(params: { latitude: number; longitude: number }) {
  const url = new URL("https://air-quality-api.open-meteo.com/v1/air-quality");
  url.searchParams.append("latitude", params.latitude.toString());
  url.searchParams.append("longitude", params.longitude.toString());
  url.searchParams.append("hourly", "pm10,pm2_5,european_aqi,us_aqi,uv_index");
  url.searchParams.append("timezone", "auto");
