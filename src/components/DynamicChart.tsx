...
// PanWeather palette: Deep blues, vibrant neons
const COLORS = ["#38bdf8", "#4ade80", "#fbbf24", "#f87171", "#c084fc", "#60a5fa"];
...
export const DynamicChart: React.FC<DynamicChartProps> = ({ widget }) => {
  ...
  return (
    <div className="bg-white/5 backdrop-blur-[40px] rounded-[32px] text-white flex flex-col h-full overflow-hidden border border-white/10 shadow-2xl transition-all duration-500 hover:bg-white/10 group">
      ...
      <div className="flex-1 min-h-[250px] w-full p-4 relative">
        {renderChart()}
      </div>
    </div>
  );
